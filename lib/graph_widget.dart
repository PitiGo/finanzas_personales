...
class PiesGraphWidget extends StatefulWidget {
  final List<double> data;

  const PiesGraphWidget({Key key, this.data}) : super(key: key);
  @override
  _PiesGraphWidgetState createState() => _PiesGraphWidgetState();
}

class _PiesGraphWidgetState extends State<PiesGraphWidget> {
  @override
